...
public class MyProducerConsumer {
	...
	public MyProducerConsumer(Object consumerMonitor, Object producerMonitor) {
		super();
	...
	class Consumer implements Runnable{
		...
		private List<String> consumerProducts;
	...
	public static void main(String[] args) {
		MyProducerConsumer pcm = new MyProducerConsumer(new Object(), new Object());
